...
alias mr-mount="sudo mount -t cifs //100.123.34.78/MoltenRiver /mnt/molten-river -o username=molten-river,password=MoltenRiverIsKing,vers=2.0,uid=$(id -u),gid=$(id -g)"
alias mr-umount="sudo umount /mnt/molten-river"
...
alias onyx-cloc='cloc --include-lang="C","C++","C/C++ Header" --exclude-dir=build --not-match-f="spirv\.hpp|ttf\.hpp"'
